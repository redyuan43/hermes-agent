...
def remove_path_from_shell_configs():
    """Remove SIYUAN PATH entries from shell configuration files."""
...
def run_gui_uninstall(args):
    ...
    print(color("│         ⚕ SIYUAN Chat GUI Uninstaller                  │", Colors.MAGENTA, Colors.BOLD))
    print(color("└─────────────────────────────────────────────────────────┘", Colors.MAGENTA, Colors.BOLD))
    print()

    if not summary["gui_installed"]:
        print("No SIYUAN Chat GUI installation was found.")
        print(f"  Checked: {hermes_home}, and the standard app locations for this OS.")
        return

    print(color("This removes the Chat GUI only. The SIYUAN agent stays installed.", Colors.CYAN))
    print()
    ...
    if agent_is_installed(hermes_home):
        ...
        print(f"  • The SIYUAN agent at {hermes_home / 'hermes-agent'}")
    ...
    print(color("└─────────────────────────────────────────────────────────┘", Colors.GREEN, Colors.BOLD))
    print()
    print("The SIYUAN agent is still installed. Run 'hermes' to use the CLI,")
...
def run_uninstall(args):
    ...
    print()
    print(color("┌─────────────────────────────────────────────────────────┐", Colors.MAGENTA, Colors.BOLD))
    print(color("│            ⚕ SIYUAN Uninstaller                  │", Colors.MAGENTA, Colors.BOLD))
    print(color("└─────────────────────────────────────────────────────────┘", Colors.MAGENTA, Colors.BOLD))
    print()
    ...
    if full_uninstall:
        ...
        print("This will remove the SIYUAN code but keep your configuration and data.")
...
def _print_uninstall_dry_run(*, project_root: Path, hermes_home: Path, full_uninstall: bool) -> None:
    ...
    print("  • SIYUAN PATH entries from shell configs / Windows User PATH")
    print("  • SIYUAN wrapper scripts and SIYUAN-managed node/npm/npx symlinks")
    print("  • Desktop Chat GUI artifacts")
    print(f"  • Code checkout: {project_root}")
    if full_uninstall:
        print(f"  • SIYUAN config/data: {hermes_home}")
        ...
        print(f"  • Keep SIYUAN config/data: {hermes_home}")
    print()
...
def _perform_uninstall(
    *,
    ...
    log_info("Removing SIYUAN-managed node/npm/npx symlinks...")
    ...
    if removed_node_links:
        ...
        log_info("No SIYUAN-managed node/npm/npx symlinks found")
    ...
    print()
    print("Thank you for using SIYUAN! ⚕")
    print()
