...
export const en: Translations = {
  ...
  status: {
    ...
    updateHermesConfirmTitle: "Update SIYUAN?",
    updatingHermes: "Updating SIYUAN…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update SIYUAN plugins (`hermes plugins` parity).",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that SIYUAN doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible SIYUAN badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning SIYUAN session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run SIYUAN more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once SIYUAN sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "SIYUAN is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
