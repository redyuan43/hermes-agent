...
class TestClaudeCodeCliAuxiliaryProvider:
    def test_resolve_provider_client_supports_reference(self, monkeypatch):
    ...
    def test_resolve_provider_client_rejects_aggregator(self, monkeypatch):
        monkeypatch.setattr("hermes_cli.auth.shutil.which", lambda command: f"/usr/local/bin/{command}")
    ...
    def test_cached_reference_does_not_bypass_aggregator_guard(self, monkeypatch):
    ...
    def test_call_llm_passes_task_to_explicit_provider(self):
