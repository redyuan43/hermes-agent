// Launching the SIYUAN TUI in the user's OWN terminal emulator.
//
...
// to work anywhere:
//
//  1. WHAT to run. The desktop's SIYUAN runtime is often a venv Python invoked
 ...
 * headless child) is the wrong answer for an interactive terminal. The SIYUAN
