...
export const en: Translations = {
  ...
  boot: {
    ready: 'SIYUAN Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading SIYUAN settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote SIYUAN backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting SIYUAN Desktop…'
    },
    errors: {
      backgroundExited: 'SIYUAN background process exited.',
      backgroundExitedDuringStartup: 'SIYUAN background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your SIYUAN backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update SIYUAN',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting SIYUAN Desktop.',
    ...
    native: {
      ...
      inputBody: 'SIYUAN is waiting for your response.',
      turnDoneTitle: 'SIYUAN finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to SIYUAN defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the SIYUAN backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the SIYUAN backend to manage this plugin from Desktop.',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while SIYUAN is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'SIYUAN asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while SIYUAN was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while SIYUAN was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let SIYUAN follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and SIYUAN can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by SIYUAN when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let SIYUAN walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what SIYUAN is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen SIYUAN, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'SIYUAN Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The SIYUAN runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'SIYUAN checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading SIYUAN configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening SIYUAN.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every SIYUAN gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by SIYUAN Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'SIYUAN Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The SIYUAN runtime managed by this app.',
      kindRemoteDesc: 'A SIYUAN gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your SIYUAN Cloud account.',
      kindSshDesc: 'A SIYUAN install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers SIYUAN manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under SIYUAN Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a SIYUAN backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      ...
      localDesc: 'Start a private SIYUAN backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote SIYUAN backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'SIYUAN Cloud',
      cloudDesc: 'Sign in once to SIYUAN Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'SIYUAN Cloud',
      cloudSignIn: 'Sign in to SIYUAN Cloud',
      cloudSignedIn: 'Signed in to SIYUAN Cloud',
      cloudNeedsSignIn: 'Sign in to SIYUAN Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your SIYUAN Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'SIYUAN Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of SIYUAN Cloud',
      cloudSignedOutMessage: 'Cleared the SIYUAN Cloud session.',
      ...
      restartingMessage: 'SIYUAN Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · SIYUAN ${version}` : ''}`,
      ...
      sshDesc:
        'SIYUAN is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'SIYUAN path (optional)',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — SIYUAN found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — SIYUAN runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'SIYUAN is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the SIYUAN path.',
      sshErrPlatform:
        'Unsupported remote platform. SIYUAN Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update SIYUAN on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to SIYUAN. Review the exact configuration below — it comes from the link, not from SIYUAN.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. SIYUAN runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point SIYUAN at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  starmap: {
    ...
    emptyDesc: 'As SIYUAN builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart SIYUAN to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update SIYUAN to generate pets.',
      backgroundHint: 'You can close this — SIYUAN will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure SIYUAN desktop' },
    ...
    hermesActiveSessions: (version, count) => `SIYUAN ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote SIYUAN you point it at, instead of this computer.',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent SIYUAN environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'SIYUAN did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. SIYUAN will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the SIYUAN backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from SIYUAN. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the SIYUAN backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting SIYUAN...',
    placeholderReconnecting: 'Reconnecting to SIYUAN…',
    ...
    attachUrlDesc: 'SIYUAN will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask SIYUAN to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating SIYUAN…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting SIYUAN…',
    ...
    unsupportedMessage: 'This version of SIYUAN can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of SIYUAN is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected SIYUAN backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed SIYUAN from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'SIYUAN will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the SIYUAN desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The SIYUAN updater takes over in its own window and reopens SIYUAN automatically when it’s done. Please don’t reopen SIYUAN yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. SIYUAN reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then SIYUAN reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update SIYUAN?',
    blockerBody:
      'SIYUAN needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update SIYUAN',
    foreignBlockerBody:
      'SIYUAN can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'SIYUAN can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'SIYUAN needs a one-time install',
    ...
    setupChoiceTitle: 'Set up SIYUAN Desktop',
    setupChoiceDesc:
      'Connect this app to a SIYUAN gateway you already run, or install SIYUAN locally on this computer.',
    connectExistingTitle: 'Connect to existing SIYUAN',
    ...
    installLocalTitle: 'Install SIYUAN locally',
    installLocalDesc: 'Download SIYUAN, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart SIYUAN Desktop and try again.',
    remoteSetupTitle: 'Connect to existing SIYUAN',
    remoteSetupDesc: 'Enter your gateway URL. SIYUAN Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the SIYUAN gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/hermes',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that SIYUAN gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up SIYUAN',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another SIYUAN CLI or desktop instance is running. Stop any running SIYUAN instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The SIYUAN installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with SIYUAN",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'SIYUAN is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting SIYUAN…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run SIYUAN',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point SIYUAN at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — SIYUAN connects automatically',
    ...
    authorizeThere: 'Authorize SIYUAN there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize SIYUAN there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `SIYUAN Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `SIYUAN Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. SIYUAN will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'SIYUAN is restarting...',
      askRestart: 'Ask SIYUAN to restart the server',
      lookingRestart: taskId => `SIYUAN is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'SIYUAN is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask SIYUAN to open a page.',
      finishedRestarting: message => `SIYUAN finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'SIYUAN could not restart the server.',
      stillWorking:
        'SIYUAN is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'SIYUAN is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'SIYUAN gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). SIYUAN won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'SIYUAN needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'SIYUAN needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart SIYUAN Desktop to use Save Image.',
    restartToSaveImages: 'Restart SIYUAN Desktop to save images',
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions SIYUAN loads when the work calls for them.'
      },
      messaging: {
        title: 'SIYUAN away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything SIYUAN made',
      ...
      profiles: {
        ...
        text: 'Each one is its own SIYUAN — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
