...
export const DARK_SEEDS: ThemeSeeds = {
  accent: '#FFBF00',
  // The classic SIYUAN navy surfaces are IDENTITY, not derivation drift —
...
// The classic light-mode SIYUAN look was never hand-authored: for years the
...
//
// Anything we can't decide stays dark — the default SIYUAN palette
// is the dark one.
...
export function fromSkin(
  ...
  //    base seeds for this polarity. The base's IDENTITY FILLS (SIYUAN navy
  ...
  // the derived value already carries the identity seeds (e.g. SIYUAN navy).
  const activeRow =
