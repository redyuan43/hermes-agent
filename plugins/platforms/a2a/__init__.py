"""
A2A (Agent-to-Agent) plugin for SIYUAN.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes SIYUAN as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    ...
    print_info("Expose SIYUAN as an A2A-discoverable agent and call other A2A agents.")
