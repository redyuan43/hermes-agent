...
the CLI through OS package managers and signed installers, so SIYUAN expects
...
def cmd_setup(args: argparse.Namespace) -> int:
    ...
    console.print(
        Panel.fit(
            ...
            "SIYUAN resolves [cyan]op://vault/item/field[/cyan] references through your\n"
    ...
    if binary and not token_set:
        ...
        if who:
            ...
            console.print(
                ...
                "SIYUAN will warn and skip 1Password on next startup.[/yellow]"
            )
    if not references:
        console.print(
...
def cmd_token(args: argparse.Namespace) -> int:
    ...
    console.print(
        ...
        "Takes effect on the next SIYUAN invocation."
    )
    if not op_cfg.get("enabled"):
        console.print(
