...
// "Timed out connecting to SIYUAN backend" that hangs the UI (#48504).
//
...
export class HermesGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
      closedErrorMessage: 'SIYUAN gateway connection closed',
      connectErrorMessage: 'Could not connect to SIYUAN gateway',
      createRequestId: nextId => nextId,
      notConnectedErrorMessage: 'SIYUAN gateway is not connected',
