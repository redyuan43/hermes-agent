...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your SIYUAN session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show SIYUAN session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running SIYUAN agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update SIYUAN to the latest version"},
        {"name": "restart", "description": "Gracefully restart the SIYUAN gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a SIYUAN session in it",
