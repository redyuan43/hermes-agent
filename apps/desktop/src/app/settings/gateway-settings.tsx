...
// SIYUAN Cloud discovery lifecycle for the cloud-mode panel.
...
export function GatewaySettings({ embedded = false }: { embedded?: boolean } = {}) {
  ...
  return (
    <SettingsContent bare={embedded}>
      ...
      {/* SIYUAN Cloud panel: one portal sign-in, then a discovered-agent picker
