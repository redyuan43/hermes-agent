...
/** Why a known SIYUAN command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active SIYUAN profile', surface: action('profile') },
  {
    name: '/skin',
 ...
 * SIYUAN' built-in slash commands — i.e. skill commands (`/gif-search`,
 ...
 * activity — the ones that ship with SIYUAN and were never asked for. It is
