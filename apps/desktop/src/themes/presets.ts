...
/**
 * Nous — the canonical SIYUAN desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays SIYUAN's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical SIYUAN desktop identity: GitHub's chrome carrying Nous
